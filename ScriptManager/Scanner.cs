...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 13; i <= 13; ++i) start[i] = 8;
		for (int i = 0; i <= 9; ++i) start[i] = 5;
		for (int i = 11; i <= 12; ++i) start[i] = 5;
		for (int i = 14; i <= 65535; ++i) start[i] = 5;
		start[Buffer.EOF] = -1;
	...
	Token NextToken() {
		...
		if (ch == ';' && Comment0() ||ch == 10 && Comment1() ||ch == '/' && Comment2()) return NextToken();
		int apx = 0;
		t = new Token();
		...
		switch (state) {
			...
			case 3:
				{t.kind = 2; break;}
			case 4:
				if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '9' || ch >= ';' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); goto case 4;}
			...
			case 7:
				{
					...
					t.kind = 5; break;}
			case 8:
				if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '"' || ch >= '%' && ch <= '9' || ch >= ';' && ch <= '@' || ch == '[' || ch >= ']' && ch <= '`' || ch >= '{' && ch <= 65535) {AddCh(); goto case 4;}
				else if (ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 11;}
			...
			case 11:
				if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '/' || ch >= ';' && ch <= '@' || ch == '[' || ch >= ']' && ch <= '`' || ch >= '{' && ch <= 65535) {AddCh(); goto case 4;}
				else if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 11;}
				else if (ch == 92) {AddCh(); goto case 10;}
